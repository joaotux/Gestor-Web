...
class SubgruposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subgrupo" do
    assert_difference('Subgrupo.count') do
      post subgrupos_url, params: { subgrupo: { grupo_id: @subgrupo.grupo_id, nome: @subgrupo.nome } }
    end
  ...
  test "should update subgrupo" do
    patch subgrupo_url(@subgrupo), params: { subgrupo: { grupo_id: @subgrupo.grupo_id, nome: @subgrupo.nome } }
