...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { nome: @categorium.nome, subgrupo_id: @categorium.subgrupo_id } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { nome: @categorium.nome, subgrupo_id: @categorium.subgrupo_id } }
